...
class JMart
{
		...
		for (; ; ) 
		{
			...
			switch(productId)
			{
				...
				case 103:{
					...
					totalBill += 20000;
					System.out.println("Smart Watch added inside cart");
					break;
				}
				case 104:{
	...
	public static void footwearPage()
	{
		...
		{
			System.out.println();
			System.out.println("  ** Footwear Page *** ");
			System.out.println();
	...
	{	
		...
		for (; ; ) 
		{
			...
			System.out.println();
			System.out.println("Do u want to remove some product(yes/no) : ");
			String opt1 = sc.next();
			if(opt1.equals("yes"))
			{
				...
				for (String product : cart1 ) 
				{
					...
					if(arr[0].equalsIgnoreCase(productName)){
						...
						System.out.println();
						System.out.println
						("Removed "+ productName + " from the cart ");
						System.out.println();
					}
					indx++;
				}
			...
			System.out.println();
			System.out.print("Do u want to checkout(yes/no) : ");
			String opt = sc.next();
			if(opt.equals("yes"))
			{
				System.out.println(" ");
